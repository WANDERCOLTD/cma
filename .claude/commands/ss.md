...
3. Describe what you see in each screenshot. If any show the 4wd project (UI, error, terminal), provide specific context — which page, what's wrong, what to do next. Label each screenshot with its filename and order (e.g. "Screenshot 1 of 3 (most recent)").
