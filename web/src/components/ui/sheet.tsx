...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/95 backdrop-blur-xl border-border shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 p-6 pr-12 border-b border-border/60",
      className,
    )}
    {...props}
  />
